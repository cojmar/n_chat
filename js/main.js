    ...
    requirejs([
        ...
        $(function() {
            ...
            net.remove_spaces = function(str) {
                return str.replace(/[‎‏​\u00a0\u2000-\u200a\u2028\u205f\u3000ㅤ]/g, '').replace(/&lrm;/g, '').replace(/&rlm;/g, '').replace(/&#x3164;/g, '').replace(/&#8203;/g, '').replace(/&#12644;/g, '').replace(/[&]/g, '&amp;');
            };

            net.remove_numbers = function(str) {
                return str.replace(/[0-9Ӡ０１２３４５６７８９𝟎𝟏𝟐𝟑𝟒𝟓𝟔𝟕𝟖𝟗𝟢𝟣𝟤𝟥𝟦𝟧𝟨𝟩𝟪𝟫𝟘𝟙𝟚𝟛𝟜𝟝𝟞𝟟𝟠𝟡⓪①②③④⑤⑥⑦⑧⑨⑩⑪⑫⑬⑭⑮⑯⑰⑱⑲⑳⓵⓶⓷⓸⓹⓺⓻⓼⓽⓾⓿⓫⓬⓭⓮⓯⓰⓱⓲⓳⓴⒈⒉⒊⒋⒌⒍⒎⒏⒐⒑⒒⒓⒔⒕⒖⒗⒘⒙⒚⒛⑴⑵⑶⑷⑸⑹⑺⑻⑼⑽⑾⑿⒀⒁⒂⒃⒄⒅⒆⒇]/g, '');
            };
