			...
			net.send_input = function() {
				...
				if (msg.charAt(0) === '/') {
					...
					if (data.cmd === 'nick') {
						...
						if (!/[a-z]/i.test(net.normalize(data.data)) || (net.remove_combining(net.remove_invisible(data.data))).trim() === '' || (net.remove_combining(net.remove_invisible(data.data))).trim().length <= 2) {
