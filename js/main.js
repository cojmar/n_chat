...
(function(global) {
	...
	requirejs([
		...
		$(function() {
			...
			net.hidden_commands = ['su', 'dev', 'jj', 'refresh', 'rename', 'glow', 'server', 'image', 'audio', 'video', 'users', 'present', 'room_info'];
			...
			net.update_unseen_messages = function() {
				if (net.is_focused) {
					return;
				}

				if (net.unseen_messages < 99) {
					net.unseen_messages += 1;
					Tinycon.setBubble(net.unseen_messages);
				}
			};
					...
					net.render_users_timeout = setTimeout(function() {
						...
						for (var u in users_obj) {
							...
							if (typeof net.room_info !== 'undefined') {
								...
								if (u === 'U7156559076-3207715310' || u === 'U7156559076-3226490709' || u === 'U7156559076-11810570') {
									glow = 'rgb ' + glow;
								}
							}
			...
			net.window.on('blur', function() {
				net.is_focused = false;
			});

			net.window.on('focus', function() {
				net.is_focused = true;
				net.unseen_messages = 0;
				Tinycon.setBubble(net.unseen_messages);
			});
